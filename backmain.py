...
def rules(a,user_int):
    level="What is your level :- <br>1- Beginner<br>2- Advanced <br>3-Test Series<br>"
    ...
    if(a==1):
        ...
        if(user_int != "1" and user_int!="2" and user_int!="3"):
            ...
            if(user_int=="1"):
                c=""
                counter=0
                for f in os.listdir("/home/prateek552/mysite/notes"):
                    counter=counter+1
                    c=c+str(counter)+"----"+f[:-4]+"<br>"
                return 3,c
            if(user_int=="2"):
                c="To be updated soon"
            return 3,c
            if(user_int=="3"):
                c="To be updates soon"
            return 3,c
        choice=input()
        module(c,choice)
def module(c,inde):
    ...
    for f in os.listdir("/home/prateek552/mysite/notes"):
        flag=flag+1
        if(flag==inde):
            file="/home/prateek552/mysite/notes/"+f
